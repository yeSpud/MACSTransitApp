...
class StopClickedTest {
	...
	fun timeFormatTest() {
		/*
		Assert.assertEquals("12:00 pm", StopClicked.formatTime("12:00").lowercase(Locale.getDefault()))
		Assert.assertEquals("12:30 pm", StopClicked.formatTime("12:30").lowercase(Locale.getDefault()))
		Assert.assertEquals("11:30 am", StopClicked.formatTime("11:30").lowercase(Locale.getDefault()))
		Assert.assertEquals("1:00 pm", StopClicked.formatTime("13:00").lowercase(Locale.getDefault()))
		Assert.assertEquals("11:59 am", StopClicked.formatTime("11:59").lowercase(Locale.getDefault()))
		Assert.assertEquals("12:01 pm", StopClicked.formatTime("12:01").lowercase(Locale.getDefault()))
		Assert.assertEquals("12:59 am", StopClicked.formatTime("00:59").lowercase(Locale.getDefault()))
		Assert.assertEquals("12:00 am", StopClicked.formatTime("00:00").lowercase(Locale.getDefault()))
		Assert.assertEquals("11:59 pm", StopClicked.formatTime("23:59").lowercase(Locale.getDefault()))
